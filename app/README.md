...
หน้า **ตั้งค่า** ถูกล็อกด้วย PIN เพื่อกันคนอื่นมาแก้ค่าอุปกรณ์ (Wi-Fi/Telegram/Firebase/เกณฑ์)
รหัสเริ่มต้น **`1234`** — เข้าไปเปลี่ยน/ปิดล็อกได้ที่ ตั้งค่า → “ล็อกการตั้งค่า (PIN)”
(ปลดล็อกค้างไว้จนกว่าจะปิด/รีเฟรชแอป)
